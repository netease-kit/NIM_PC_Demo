...
#define NIM_SDK_GET_FUNC_FROM_INSTANCE(instance,function_ptr)	\
						((function_ptr)instance->GetFunction(#function_ptr) != NULL ? ((function_ptr)instance->GetFunction(#function_ptr)) : (nim::nim_print_unfound_func_name(#function_ptr),(function_ptr)nim::unfound_function_holder))
