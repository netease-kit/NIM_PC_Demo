...
/** @fn void nim_super_team_invite_async2(const char *tid, const char *jsonlist_uids, const char *invitation_postscript, const char *invitation_attachment,const char *json_extension, nim_team_opt_cb_func cb, const void *user_data)
  * 邀请
  * @param[in] tid		群组id
  * @param[in] jsonlist_uids		uids string array
...
/** @fn void nim_super_team_query_teams_info_by_keyword_async(const char* keyword, const char *json_extension,nim_super_team_query_all_my_teams_info_cb_func cb, const void *user_data)
  * 查询本地所有群信息（默认查询有效群-群有效AND我在群里-）
...
/** @fn void nim_super_team_apply_join_async(const char *tid, const char *reason, const char *json_extension, nim_super_team_opt_cb_func cb, const void *user_data)
  * 申请入群
  * @param[in] tid		群组id
  * @param[in] reason	附言
  * @param[in] json_extension json扩展参数（备用，目前不需要）
...
/** @fn void nim_super_team_pass_join_apply_async(const char *tid, const char *applicant_id, const char *json_extension, nim_super_team_opt_cb_func cb, const void *user_data)
  * 同意入群申请
  * @param[in] tid		群组id
...
/** @fn void nim_super_team_reject_join_apply_async(const char *tid, const char *applicant_id, const char *reason, const char *json_extension, nim_super_team_opt_cb_func cb, const void *user_data)
  * 拒绝入群申请
  * @param[in] tid		群组id
  * @param[in] applicant_id	申请者id
  * @param[in] reason		附言
...
/** @fn void nim_super_team_add_managers_async(const char *tid, const char *jsonlist_admin_ids, const char *json_extension, nim_super_team_opt_cb_func cb, const void *user_data)
  * 添加管理员
  * @param[in] tid		群组id
...
/** @fn void nim_super_team_remove_managers_async(const char *tid, const char *jsonlist_admin_ids, const char *json_extension, nim_super_team_opt_cb_func cb, const void *user_data)
  * 删除管理员
  * @param[in] tid		群组id
  * @param[in] jsonlist_admin_ids	uids string array
  * @param[in] json_extension json扩展参数（备用，目前不需要）
...
/** @fn void nim_super_team_transfer_team_async(const char *tid, const char *new_owner, bool is_leave, const char *json_extension, nim_super_team_opt_cb_func cb, const void *user_data)
  * 移交群主
  * @param[in] tid		群组id
...
/** @fn void nim_super_team_update_other_nick_async(const char *info, const char *json_extension, nim_super_team_opt_cb_func cb, const void *user_data)
  * 修改别人的群昵称
...
/** @fn void nim_super_team_accept_invitation_async(const char *tid, const char *invitor, const char *json_extension, nim_super_team_opt_cb_func cb, const void *user_data)
  * 接受邀请
  * @param[in] tid		群组id
...
/** @fn void nim_super_team_reject_invitation_async(const char *tid, const char *invitor, const char *reason, const char *json_extension, nim_super_team_opt_cb_func cb, const void *user_data)
  * 拒绝邀请
  * @param[in] tid		群组id
  * @param[in] invitor	邀请者id
  * @param[in] reason	附言
...
/** @fn void nim_super_team_mute_member_async(const char *tid, const char *member_id, bool set_mute, const char *json_extension, nim_super_team_opt_cb_func cb, const void *user_data)
  * 对群成员禁言/解除禁言
  * @param[in] tid		群组id
