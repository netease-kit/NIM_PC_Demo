...
/** @fn bool nim_audio_play_audio(const char* file_path, const char* call_id, const char* res_id, int audio_format)
  ...
  * @return bool true 调用成功，false 调用失败
  */
NIM_SDK_DLL_API bool nim_audio_play_audio(const char* file_path, const char* call_id, const char* res_id, int audio_format);
...
/** @fn bool nim_audio_start_capture(const char* call_id, const char* res_id, int audio_format = 0, int volume = 180, int loudness = 0, const wchar_t* capture_device = nullptr)
  ...
  * @return bool true 调用成功，false 调用失败
  */
NIM_SDK_DLL_API bool nim_audio_start_capture(const char* call_id, const char* res_id, int audio_format = 0, int volume = 180, int loudness = 0, const wchar_t* capture_device = nullptr);
...
/** @fn bool nim_audio_cancel_audio(const char* file_path)
  ...
  * @return bool true 调用成功，false 调用失败
  */
NIM_SDK_DLL_API bool nim_audio_cancel_audio(const char* file_path);
