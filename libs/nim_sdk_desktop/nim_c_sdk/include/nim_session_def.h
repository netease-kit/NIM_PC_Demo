...
static const char *kNIMSessionType			= "type";				/**< int, 会话类型(NIMSessionType 个人0 群组1 etc) */
...
static const char *kNIMSessionMsgTime		= "msg_time";			/**< int, 本地消息历史中该会话最后一条消息的时间 */
static const char *kNIMSessionMsgType		= "msg_type";			/**< int, 本地消息历史中该会话最后一条消息的类型 */
