...
const std::wstring RichEditWithDefMenu::kMenuBTNName_Cut = L"MID_CUT";//剪切
const std::wstring RichEditWithDefMenu::kMenuBTNName_Copy = L"MID_COPY";//复制
const std::wstring RichEditWithDefMenu::kMenuBTNName_Paste = L"MID_PASTE";//粘贴
