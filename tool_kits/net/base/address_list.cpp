...
void AddressList::Append(const struct addrinfo* head) {
  ...
  data_.reset(new Data(new_head, false /*is_system_created*/));
...
void AddressList::SetPort(uint16_t port) {
  ...
  data_.reset(new Data(head, false /*is_system_created*/));
}

uint16_t AddressList::GetPort() const {
