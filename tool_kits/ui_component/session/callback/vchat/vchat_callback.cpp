...
void VChatCallback::DeviceStatusCb(nim::NIMDeviceType type, UINT status, const char* path, const char *json)
{
...
void VChatCallback::VideoCaptureData(unsigned __int64 time, const char* data, unsigned int size, unsigned int width, unsigned int height, const char *json)
{
...
void VChatCallback::VideoRecData(unsigned __int64 time, const char* data, unsigned int size, unsigned int width, unsigned int height, const char *json)
{
	std::string data_temp(data, size);
