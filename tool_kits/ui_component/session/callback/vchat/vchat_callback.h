...
public:
	...
	static void DeviceStatusCb(nim::NIMDeviceType type, UINT status, const char* path, const char* json);
	static void StartDeviceCb(nim::NIMDeviceType type, bool ret, const char* json, const void*);
	static void VideoCaptureData(unsigned __int64 time, const char* data, unsigned int size, unsigned int width, unsigned int height, const char* json);
	static void VideoRecData(unsigned __int64 time, const char* data, unsigned int size, unsigned int width, unsigned int height, const char* json);
