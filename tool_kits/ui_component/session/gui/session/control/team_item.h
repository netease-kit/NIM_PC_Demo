...
public:
	...
	* @return void 无返回值
	*/
	void InitInfo(const nim::TeamMemberInfo &info);
	...
	* @return void 无返回值
	*/
	void OnUserInfoReady(const UserInfo& uinfo);
	...
	* @return void 无返回值
	*/
	void SetTeamMember(const nim::TeamMemberInfo& team_member_info);
...
private:
	...
	* @return void 无返回值
	*/
	void SetMemberName(const UserInfo& uinfo, const std::string& team_card);
private:
